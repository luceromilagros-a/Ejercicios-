...
print(f"El primer numero es {numero} y el segundo es {numero_dos}")
...
while contador > 0:
    if contador == 5:
        print("Estamos en la mitad de las iteraciones..Estamos en la quinta")
    else:
        print(f"contador: {contador}")
    contador -= 1
    # acá termina el bloque de codigo si da True
    # aca va a preguntar otra vez la condicion
...
# no continuamos con el programa
