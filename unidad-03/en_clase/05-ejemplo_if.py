...
if alumno_edad > 40:
    ...
    print("el alumno es mayor de 40 años")
    # acá termina el bloque de codigo

elif alumno_edad >= 30
    print("el alumno es mayor de 30 años")

elif alumno_edad >= 20:
    print("el alumno es mayor de 20 años")

elif alumno_edad >= 10:
    print("el alumno es mayor de 10 años")

else:
    print("el alumno es menor de 10 años")
