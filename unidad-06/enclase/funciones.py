def sumar(numero_uno, numero_dos, numero_tres):
    # va a sumar dos numeros y va a retornar el total
    sub_total = numero_uno + numero_dos + numero_tres
    print(f"el total es {sub_total}")
    # return sub_total
